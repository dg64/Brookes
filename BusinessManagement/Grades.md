...
#### Question 5
	...
	b
		...
		ii		0/2
				remote working makes difficult the appraisal

	c			2/4
				You provided only one disadvantage.
				It is costly

	d			10/10
				Good analysis

Total Score 32/40 Grade 6
...
#### Question 1
	...
	a			0/2
				Not answered
				ratio of conversion of input to output
...
#### Question 2
	...
	b			1/6
				Beside some errors of calculation, kg have no place
...
#### Question 4
	...
	b			2/4
				the USP can be used for advertising and as a reason for
				asking an increased price

	c			0/4
				Easy to calculate, but inflexible

	d			4/10
				Your answer is unbalanced, as you have to provide one advantage
				and one disadvantage for each option. Coming to the content of your
				answer, there is no reference to Ansoff matrix, market penetration
				and diversification, with their implication

Total Score 10/40 Grade 2
...
#### Question 5
	...
	a			0/2
				sales of shares in the public market
				publishing of internal account

	b
		i		0/2
				No reference to Maslow as requested in the question
	...
	d			3/10
				There is no introduction and your answer is unbalanced as you
				have to provide one advantage and one disadvantage for each 
				option

Total Score 9/40 Grade 2
...
#### Question 1
	...
	c	
		...
		ii		1/2
				The result is correct, but you were required to show all your
				working, not to write just the final result
